...
<div class="container">
  		...
  		<form class="form-horizontal bs-docs-example "  method="post">
            ...
            <div class="control-group">
              <label class="control-label" for="inputEmail">已绑定邮箱</label>
              <div class="controls">
                <label class="control-label" for="inputEmail">zzzzz</label>
              </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label" for="inputPassword">新邮箱地址</label>
              <div class="controls">
